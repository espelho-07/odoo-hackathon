...
const AdminDashboard = () => {
    ...
    const leaveColumns = [
        { header: 'Employee', accessor: 'employee', render: (row) => <span className="font-medium text-slate-800">{row.employee}</span> },
    ...
    const leaveActions = (
        <div className="flex gap-2">
            <Button size="sm" variant="secondary" className="!px-2 !py-1">View</Button>
        </div>
    );
